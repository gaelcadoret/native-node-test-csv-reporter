...
56 93 4
    ...
    it.only('should return the minimum location number ??? for a given entry', () => {
        // Given
        const entry = `
        seeds: 304740406 53203352
...
130183265 2386051074 290870825
        ...
        // When
        const entryMap = parseEntry(entry);
        const minLocation = getMinLocationV3(entryMap);
        assert.equal(minLocation, 993500720)
    })
})